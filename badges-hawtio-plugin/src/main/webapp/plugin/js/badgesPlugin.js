...
var Simple = (function(Simple) {
     ...
     */
    Simple.pluginName = 'badges_plugin';
     ...
     *
     */
    Simple.contextPath = "/badges-plugin/";
     ...
     * run function
     */
    Simple.module = angular.module('badges_plugin', ['hawtioCore'])
        .config(function($routeProvider) {
            ...
            $routeProvider.
                when('/badges', {
                    templateUrl: Simple.templatePath + 'badges.html'
                });
        });
    ...
    Simple.module.run(function(workspace, viewRegistry, layoutFull) {
        ...
        Core.addCSS(Simple.contextPath + "plugin/css/badges.css");

        // tell the app to use the full layout, also could use layoutTree
        // to get the JMX tree or provide a URL to a custom layout
        viewRegistry["badges_plugin"] = layoutFull;
        ...
        workspace.topLevelTabs.push({
            ...
            href: function() { return "#/badges"; },
            isActive: function(workspace) { return workspace.isLinkActive("badges_plugin"); }
